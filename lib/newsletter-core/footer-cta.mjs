...
export const NEWSLETTER_FOOTER_CTA_VARIANTS = {
  default: {
    ...
    text: 'I work with teams that need speculative and material prototyping, anticipatory research, and design fiction to make possible futures easier to see, discuss, and act on. I am open to commissions, collaborations, advisory work, and full-time roles where this kind of artifact-led thinking can shape strategy, policy, products, marcomms, services, and help with the development of organizational imagination.',
    primaryAction: {
      label: 'Let’s Talk',
