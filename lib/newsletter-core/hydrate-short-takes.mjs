...
function validateRecord(record, index) {
  ...
  if (record.url !== undefined) normalized.url = resolveDestinationUrl(record.url, `${prefix}.url`);
...
export function hydrateShortTakeSections(newsletterData, repoRoot, { logger = console } = {}) {
  ...
  newsletterData.sections.forEach((section, sectionIndex) => {
    ...
    const hydratedItem = {
      ...
      caption: record.url ? captionWithoutNestedAnchors(record.caption) : record.caption,
